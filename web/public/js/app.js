...
/* harmony import */ var _components_Message_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Message.vue */ "./resources/js/components/Message.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    //このidとlikedはどこからきたのかが分からない。4/23
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 6:
                //理解するのに苦労した。this.photosの中にあるそれぞれのphotoに対してアクセサを用いて処理をかける。
...
var routes = [{
  ...
  //<PhotoList> コンポーネントにクエリパラメータとしてpropsが与えられる
